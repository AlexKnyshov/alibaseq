...
The following are assumptions used in developing of the script:
* Technical
...
* Methodological
	...
	- no sequence fragment order rearrangements are assumed (in case of multiple hits or multiple contigs they are arranged as in bait)
...
* `<bait_name> [`
	* `[<supercontig_index>, [`
		* `[True],`
		* `[<supercontig_evalue>, <supercontig_evalue>, <supercontig_identity>],`
